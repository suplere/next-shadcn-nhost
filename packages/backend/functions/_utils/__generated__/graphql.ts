...
export type GetAllUsersIdQuery = { __typename?: 'query_root', users: Array<{ __typename?: 'users', id: any }> };
...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    getAllUsersId(variables?: GetAllUsersIdQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<GetAllUsersIdQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<GetAllUsersIdQuery>(GetAllUsersIdDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'getAllUsersId', 'query', variables);
    }
  };
}
